...
import com.example.mybaidupanorma.activity.TemplateActivity;
import com.example.mybaidupanorma.activity.UploadVideoActivity;
import com.example.mybaidupanorma.fragment.FoundFragment;
import com.example.mybaidupanorma.fragment.IndexFragment;
import com.example.mybaidupanorma.fragment.MessageFragment;
import com.example.mybaidupanorma.fragment.MyPageFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvMsg = findViewById(R.id.tv_main_msg);
    ...
    public void textClick(View view){
        switch (view.getId()){
            ...
            case R.id.tv_main_msg:
                tvFirst.setTextColor(getResources().getColor(R.color.black));
                tvFound.setTextColor(getResources().getColor(R.color.black));
                tvMsg.setTextColor(getResources().getColor(R.color.textClick));
                tvMine.setTextColor(getResources().getColor(R.color.black));
    ...
    private void clickButton() {
        ...
        TextView tvCustomize=view.findViewById(R.id.tv_customize);
