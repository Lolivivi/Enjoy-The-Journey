...
public class CommentVideoExpandAdapter extends BaseExpandableListAdapter {
    private List<CommentDetailBean> commentBeanList;
    private Context context;

    public CommentVideoExpandAdapter(Context context, List<CommentDetailBean> commentBeanList){
    ...
    public View getGroupView(final int groupPosition, boolean isExpand, View convertView, ViewGroup viewGroup) {
        ...
        groupHolder.tv_more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                VideoDetailActivity mcontext =(VideoDetailActivity)context;
                ((VideoDetailActivity) context).OnFlagClickListener(groupPosition);
            }
        });
        return convertView;
    }
...
//            btn_like = view.findViewById(R.id.reply_item_like);
//            isLike=false;
