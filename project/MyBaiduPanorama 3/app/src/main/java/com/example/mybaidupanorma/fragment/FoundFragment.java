...
import com.example.mybaidupanorma.adapter.MyFragmentPageAdapter;
...
public class FoundFragment extends Fragment {
    ...
    private JourneyFragment onlineFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        concernFragment = new ConcernFragment(activity);
        onlineFragment = new JourneyFragment();
