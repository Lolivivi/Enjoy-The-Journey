...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            SharedPreferences sharedPreferences = getApplicationContext().getSharedPreferences("setting", Context.MODE_PRIVATE);
            String phone = sharedPreferences.getString("tel", edPhone.getText().toString());
            String pwd = sharedPreferences.getString("pwd", edPwd.getText().toString());
        });
        //点击注册按钮跳转到注册页面
