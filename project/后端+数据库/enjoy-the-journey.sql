...
) ENGINE = InnoDB AUTO_INCREMENT = 76 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '�ղ�' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tbl_collection
-- ----------------------------
INSERT INTO `tbl_collection` VALUES (75, 1, '1', 'false');
...
CREATE TABLE `tbl_comments`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 83 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '���۱�' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `tbl_follow` VALUES (37, '1', '2');
INSERT INTO `tbl_follow` VALUES (38, '1', '0');
INSERT INTO `tbl_follow` VALUES (40, '\'1\'', '\'1\'');
INSERT INTO `tbl_follow` VALUES (41, '\'1\'', '\'1\'');
...
INSERT INTO `tbl_user` VALUES ('1', '左宗棠', '1', '1.jpg', '男', '左宗棠（1812年11月10日—1885年9月5日），汉族，字季高， [1]  一字朴存，号湘上农人。湖南湘阴人。晚清政治家、军事家、民族英雄 [2]  ，洋务派代表人物之一，与曾国藩等人并称“晚清中兴四大名臣”。');
